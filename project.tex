...
\usepackage{geometry}
 ...
 right=25mm,
 left=25mm,
 top=15mm,    % Further reduced top margin
 bottom=15mm, % Further reduced bottom margin
 headheight=14pt,
 headsep=8pt     % Further reduced space between header and text
 }
% \usepackage{fontspec}
\usepackage{tocloft}
\makeatletter
...
% Adjust unnumbered chapter spacing (for Appendix, Abstract, etc.)
\def\@makeschapterhead#1{%
  \vspace*{10pt}% Reduced from default 50pt - same as numbered chapters
  {\parindent \z@ \raggedright \normalfont
    \interlinepenalty\@M
    \Large \bfseries\centering #1\par\nobreak
    \vskip 20pt% Reduced space after title - same as numbered chapters
  }}
...
% Adjust numbered chapter spacing
